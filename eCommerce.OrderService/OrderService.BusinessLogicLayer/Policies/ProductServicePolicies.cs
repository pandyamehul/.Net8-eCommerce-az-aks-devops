...
public class ProductServicePolicies : IProductServicePolicies
{
    private readonly ILogger<ProductServicePolicies> _logger;

    public ProductServicePolicies(ILogger<ProductServicePolicies> logger)
    {
        _logger = logger;
    }
